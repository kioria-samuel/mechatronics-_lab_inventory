...
<head>
    ...
    <script src="https://kit.fontawesome.com/cf3b94705e.js" crossorigin="anonymous"></script>
     ...
     <!-- Include the mobiscroll CSS and JS resources in your files for calendar -->
   ...
   <div class="p-0 bg-light rounded rounded-pill shadow-sm  text-center m-4">
    ...
    <!-- searchbar  end-->
          ...
          <div id="demo-event-color">
            ...
            <div class="col-md-4 mb-4 justify-content-right">
                <H1>view reports</H1>
            </div>  
...
var oldEvent,
    ...
    myData = [{
        ...
        id: 3,
        start: '2022-03-07T18:00',
        end: '2022-03-07T22:00',
        title: 'Dexter BD',
        description: '',
        allDay: false,
        free: true,
        ...
        id: 4,
        start: '2022-03-09T10:30',
        end: '2022-03-09T11:30',
